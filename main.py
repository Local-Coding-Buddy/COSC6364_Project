...
#
network_file ='Random_English.net.xml'#"Braess_Homebrew_fixed1.net.xml" #'4corners_neighborhoods.net.xml'#'Random_English.net.xml'#"Braess_Homebrew_fixed1.net.xml"#"4corners_neighborhoods.net.xml" #Avenue_E_stafford_Texas.net.xml
Round_name_base ='small_test'# "On_Project"#be sure to add _Random here if you want to use the random trips 
